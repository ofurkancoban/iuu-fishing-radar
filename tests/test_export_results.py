...
def test_write_mpa_scores_and_hotspots():
    ...
    write_mpa_scores(conn, pd.DataFrame([{"mpa_id": "1", "region": "default", "score": 80.0}]))
    write_hotspots(conn, pd.DataFrame([{"h3_cell": "abc", "region": "default", "intensity": 3}]))
